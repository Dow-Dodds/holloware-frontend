...
let openCommentModal = (productId) => {
  ...
  postCommentsButton.onclick = () => {
    ...
    $.ajax({
      url: `holloware-backend.vercel.app/postComment`,
      type: 'POST',
      data: {
...
let deleteProduct = (productId) => {
  $.ajax({
    url: `holloware-backend.vercel.app/deleteProduct/${productId}`,
    type: "DELETE",
    success: () => {
      showAllProducts();
    },
...
let fillEditInputs = (product, id) => {
  ...
  $("#updateProduct").click(function () {
    ...
    $.ajax({
      url: `holloware-backend.vercel.app/updateProduct/${productId}`,
      type: "PATCH",
      data: {
        name: productName,
        price: productPrice,
...
let checkLogin = () => {
  ...
  if (loggedin == true) {
    ...
    submit.onclick = () => {
      ...
      $.ajax({
        url: `holloware-backend.vercel.app/addProduct`,
        type: "POST",
        data: {
