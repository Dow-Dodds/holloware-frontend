...
let openCommentModal = (productId) => {
  ...
  $.ajax({
    type: 'GET',
    url: `https://holloware-backend.vercel.app/product/${productId}`,
    //the success function contains an object which can be named anything 
    success: (product) => {
  ...
  postCommentsButton.onclick = () => {
    ...
    $.ajax({
      url: `https://holloware-backend.vercel.app/postComment`,
      type: 'POST',
      data: {
...
let deleteProduct = (productId) => {
  $.ajax({
    url: `https://holloware-backend.vercel.app/deleteProduct/${productId}`,
    type: "DELETE",
    success: () => {
      showAllProducts();
    },
...
let fillEditInputs = (product, id) => {
  ...
  $("#updateProduct").click(function () {
    ...
    $.ajax({
      url: `https://holloware-backend.vercel.app/updateProduct/${productId}`,
      type: "PATCH",
      data: {
        name: productName,
        price: productPrice,
...
let checkLogin = () => {
  ...
  if (loggedin == true) {
    ...
    submit.onclick = () => {
      ...
      $.ajax({
        url: `https://holloware-backend.vercel.app/addProduct`,
        type: "POST",
        data: {
